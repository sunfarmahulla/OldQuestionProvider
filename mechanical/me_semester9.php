...
$sql="SELECT * FROM `semester_papers` where branch='mech' AND semesters='tech'";
...
<table width="70%" cell padding='5' cell space='5'>
    ...
    <tr id="show">
        ...
        <td>  <a href="me_download3.php?id=<?php echo $id ?>" style="color:red;text-decoration: none;box-shadow:inset 0.5em 0 black;display: block;" ><img width="80px" height="50px" src="pdf.png"/>Download</a></td>
    </tr>
  <?php  } ?>
</table>
        </div>
