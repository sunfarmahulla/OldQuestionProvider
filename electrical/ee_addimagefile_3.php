...
.leter input[type=submit]:hover{
    ...
    <form action="ee_addimagefile_3.php" method="post" enctype="multipart/form-data">
          <lable>ID no.</lable>
    ...
    <div class="leter">
        <form action="ee_addimagefile_3.php" method="post">
...
$sql="SELECT * FROM `semester_papers` where branch='ee'";
