...
.leter input[type=submit]:hover{
    ...
    <form action="bc_addimagefile_3_1.php" method="post" enctype="multipart/form-data">
          <lable>ID no.</lable>
    ...
    <div class="leter">
        <form action="bc_addimagefile_3_1.php" method="post">
...
$sql="SELECT * FROM `semester_papers` where branch='mca'";
