...
<table width="70%" cell padding='5' cell space='5'>
    ...
    <tr id="show">
        ...
        <td> <img width="80px" height="50px" src="pdf.png"/> <a href="bc_download3.php?id=<?php echo $id ?>" style="color:red;text-decoration: none;box-shadow:inset 0.5em 0 black;display: block;" >Download</a></td>
    </tr>
  <?php  } ?>
</table>
        </div>
